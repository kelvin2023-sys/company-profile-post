...
<form action="{{ asset('admin/konfigurasi/proses') }}" method="post" accept-charset="utf-8">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                <label>Dinas Tagline/motto</label>
                <input type="text" name="tagline" placeholder="Company tagline/motto" value="<?php echo $site->tagline; ?>"
                    class="form-control">
            </div>

            <div class="form-group">
                <label>Dinas Tagline/motto 2</label>
                <input type="text" name="tagline2" placeholder="Company tagline/motto 2" value="<?php echo $site->tagline2; ?>"
                    class="form-control">
            </div>

            <div class="form-group">
                <label>Website address</label>
                <input type="url" name="website" placeholder="{{ asset('/') }}" value="<?php echo $site->website; ?>"
                    class="form-control">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="email" name="email_cadangan" placeholder="youremail@address.com"
                    value="<?php echo $site->email_cadangan; ?>" class="form-control" required>
            </div>
            ...
            <div class="form-group">
                <label>Nomor Telepon Dinas</label>
            ...
            <div class="form-group">
                ...
                <input type="text" name="hp" placeholder="021-000000" value="<?php echo $site->hp; ?>"
                    class="form-control">
            </div>
