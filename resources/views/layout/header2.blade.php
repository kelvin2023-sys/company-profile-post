    ...
    <div class="container d-flex align-items-center">
        ...
        <div class="logo mr-auto">
            <h1 class="text-light"><a href="{{ asset('/') }}"><span>
                        <img src="{{ asset('public/upload/image/' . $site->logo) }}" alt="Nitrico"
            ...
            <ul>
                ...
                <li class="drop-down"><a href="{{ asset('profil') }}review">Profil</a>
                    <ul>
                        ...
                        <li><a href="{{ asset('berita/read/' . $nav_profil->slug_berita) }}"><?php echo $nav_profil->judul_berita; ?></a>
                        </li>
                        <?php } ?>
                    </ul>
                </li>
                ...
                <li>
                    <a href="{{ asset('pemesanan') }}" class="orange" title="Form Pemesanan">
                        <div class="belanja"><i class="fa fa-shopping-cart"></i> Form Order</div>
                    </a>
                </li>
