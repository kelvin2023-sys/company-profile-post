...
class Download extends Controller
{
    ...
    public function tambah_proses(Request $request)
    {
        ...
        request()->validate([
                            ...
                            'gambar'          => 'required|file|mimes:jpeg,png,jpg,pdf,doc,docx,xls,xlsx,ppt,pptx|max:10024',
                            ]);
        // UPLOAD START
    ...
    public function edit_proses(Request $request)
    {
        ...
        request()->validate([
                            ...
                            'gambar'            => 'file|mimes:jpeg,png,jpg,pdf,doc,docx,xls,xlsx,ppt,pptx|max:10024',
                            ]);
        // UPLOAD START
        $image                  = $request->file('gambar');
        if(!empty($image)) {
